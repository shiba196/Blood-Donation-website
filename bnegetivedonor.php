...
session_start();
			...
			$query = " select * from bnegetivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['bneg_donor_name']; ?> </td>
      <td><?php echo $row['bneg_donor_email']; ?> </td>
	  <td><?php echo $row['bneg_donor_mobno']; ?> </td>
	  <td><?php echo $row['bneg_donor_address']; ?> </td>
    </tr>
