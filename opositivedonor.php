...
session_start();
			...
			$query = " select * from opositivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['opos_donor_name']; ?> </td>
      <td><?php echo $row['opos_donor_email']; ?> </td>
	  <td><?php echo $row['opos_donor_mobno']; ?> </td>
	  <td><?php echo $row['opos_donor_address']; ?> </td>
    </tr>
