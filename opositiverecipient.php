...
session_start();
			...
			$query = " select * from opositiverecipientdetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['opos_recipient_name']; ?> </td>
      <td><?php echo $row['opos_recipient_email']; ?> </td>
	  <td><?php echo $row['opos_recipient_mobno']; ?> </td>
	  <td><?php echo $row['opos_recipient_address']; ?> </td>
    </tr>
