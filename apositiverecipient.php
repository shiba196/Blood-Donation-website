...
session_start();
			...
			$query = " select * from apositiverecipientdetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['apos_recipient_name']; ?> </td>
      <td><?php echo $row['apos_recipient_email']; ?> </td>
	  <td><?php echo $row['apos_recipient_mobno']; ?> </td>
	  <td><?php echo $row['apos_recipient_address']; ?> </td>
    </tr>
