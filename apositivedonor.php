...
session_start();
			...
			$query = " select * from apositivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['apos_donor_name']; ?> </td>
      <td><?php echo $row['apos_donor_email']; ?> </td>
	  <td><?php echo $row['apos_donor_mobno']; ?> </td>
	  <td><?php echo $row['apos_donor_address']; ?> </td>
    </tr>
