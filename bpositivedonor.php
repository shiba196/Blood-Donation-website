...
session_start();
			...
			$query = " select * from bpositivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['bpos_donor_name']; ?> </td>
      <td><?php echo $row['bpos_donor_email']; ?> </td>
	  <td><?php echo $row['bpos_donor_mobno']; ?> </td>
	  <td><?php echo $row['bpos_donor_address']; ?> </td>
    </tr>
