...
session_start();
			...
			$query = " select * from anegetivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['aneg_donor_name']; ?> </td>
      <td><?php echo $row['aneg_donor_email']; ?> </td>
	  <td><?php echo $row['aneg_donor_mobno']; ?> </td>
	  <td><?php echo $row['aneg_donor_address']; ?> </td>
    </tr>
