...
session_start();
			...
			$query = " select * from abpositivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['abpos_donor_name']; ?> </td>
      <td><?php echo $row['abpos_donor_email']; ?> </td>
	  <td><?php echo $row['abpos_donor_mobno']; ?> </td>
	  <td><?php echo $row['abpos_donor_address']; ?> </td>
    </tr>
