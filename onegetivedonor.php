...
session_start();
			...
			$query = " select * from onegetivedonordetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['oneg_donor_name']; ?> </td>
      <td><?php echo $row['oneg_donor_email']; ?> </td>
	  <td><?php echo $row['oneg_donor_mobno']; ?> </td>
	  <td><?php echo $row['oneg_donor_address']; ?> </td>
    </tr>
