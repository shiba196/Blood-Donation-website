...
session_start();
			...
			$query = " select * from bnegetiverecipientdetail ";
...
?>
  <tbody>
    <tr>
      ...
      <td><?php echo $row['bneg_recipient_name']; ?> </td>
      <td><?php echo $row['bneg_recipient_email']; ?> </td>
	  <td><?php echo $row['bneg_recipient_mobno']; ?> </td>
	  <td><?php echo $row['bneg_recipient_address']; ?> </td>
    </tr>
